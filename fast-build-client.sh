...
cp src/TeamTavern/Client/Static/Libraries/* dist-client/libraries/
discriminator=`openssl rand -hex 8`
sass src/TeamTavern/Client/Style/Main.scss "dist-client/style.min.${discriminator}.css"
