...
const FIXTURES = {
    shadowFox: {
        ...
        facts: [
            ...
            { text: "Duelist, Initiator", match: "fit" },
    ...
    nightOwls: {
        ...
        facts: [
            ...
            { text: "Controller, Sentinel", match: "fit" },
            { text: "Europe", match: "fit" },
            { text: "EN", match: "fit" },
    ...
    radiantRising: {
        ...
        facts: [
            ...
            { text: "PC", match: "fit" },
            { icon: "mic", label: "Microphone required", match: "fit" },
            { text: "Ages 16+", match: "fit" },
            { text: "Ranked climb, Competitive, Leagues", match: "fit" },
        ],
        details: [{ label: "Usually online", value: "18:00–01:00" }],
    ...
    afterglow: {
        ...
        slots: { size: 4, wantedFrom: 1, wantedTo: 1 },
        facts: [
    ...
    expiredGroup: {
        ...
        expired: true,
        slots: { size: 2, wantedFrom: 2, wantedTo: 3 },
        facts: [
            { text: "Silver 1 – Gold 3", match: "miss" },
            { text: "Controller, Initiator, Duelist", match: "fit" },
            { text: "Europe", match: "fit" },
    ...
    farlands: {
        ...
        details: [
            { label: "Usually online", value: "17:00–23:00" },
