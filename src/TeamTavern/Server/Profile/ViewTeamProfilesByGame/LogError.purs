module TeamTavern.Server.Profile.ViewTeamProfilesByGame.LogError where
...
--     logStamped "Error viewing team profiles by game"
--     viewError # match
--         { databaseError: \error ->
--             logt $ "Unknown database error ocurred: " <> intercalate "\n" (reportDatabaseError error)
