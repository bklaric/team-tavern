...
insertUrlValue :: forall errors.
    Client -> ProfileId -> FieldId -> Url -> Async (InternalError_ errors) Unit
...
insertSingleValue :: forall errors.
    Client -> ProfileId -> FieldId -> OptionId -> Async (InternalError_ errors) Unit
...
insertMultiValue :: forall errors.
    Client -> ProfileId -> FieldId -> Array OptionId -> Async (InternalError_ errors) Unit
...
addFieldValues :: forall errors.
    Client -> ProfileId -> Array FieldValue -> Async (InternalError_ errors) Unit
