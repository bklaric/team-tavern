...
steamSvg class' = svg [ HS.class_ class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") steamPath ] ]
...
riotSvg class' = svg [ HS.class_ class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") riotPath ] ]
...
battleNetSvg class' = svg [ HS.class_ class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") battleNetPath ] ]
...
playStationSvg class' = svg [ HS.class_ class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") playStationPath ] ]
...
xboxSvg class' = svg [ HS.class_ class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") xboxPath ] ]
...
switchSvg class' = svg [ HS.class_ class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") switchPath ] ]
