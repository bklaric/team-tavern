...
platformSvg :: ∀ slots action. String -> Platform -> HTML slots action
...
steamSvg :: ∀ slots actions. String -> HTML slots actions
steamSvg class' = svg [ HSA.class_ $ ClassName class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") steamPath ] ]

inputSteamSvg :: ∀ slots actions. HTML slots actions
inputSteamSvg = steamSvg "input-label-icon"

detailSteamSvg :: ∀ slots actions. HTML slots actions
...
riotSvg :: ∀ slots actions. String -> HTML slots actions
riotSvg class' = svg [ HSA.class_ $ ClassName class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") riotPath ] ]

inputRiotSvg :: ∀ slots actions. HTML slots actions
inputRiotSvg = riotSvg "input-label-icon"

detailRiotSvg :: ∀ slots actions. HTML slots actions
...
xboxSvg :: ∀ slots actions. String -> HTML slots actions
xboxSvg class' = svg [ HSA.class_ $ ClassName class', viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") xboxPath ] ]

inputXboxSvg :: ∀ slots actions. HTML slots actions
inputXboxSvg = xboxSvg "input-label-icon"

detailXboxSvg :: ∀ slots actions. HTML slots actions
