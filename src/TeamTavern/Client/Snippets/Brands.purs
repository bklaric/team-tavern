...
steamSvg :: forall slots actions. HTML slots actions
steamSvg = svg [ class_ "input-label-icon", viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") steamPath ] ]
...
riotSvg :: forall slots actions. HTML slots actions
riotSvg = svg [ class_ "input-label-icon", viewBox 0.0 0.0 24.0 24.0 ] [ path [ attr (AttrName "d") riotPath ] ]
