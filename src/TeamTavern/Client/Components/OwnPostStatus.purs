...
-- | contacts were shown.
ownPostStatus :: ∀ w i.
    { now :: Instant, expires :: String, conversations :: Int, unread :: Int, reveals :: Int } -> HH.HTML w i
ownPostStatus { now, expires, conversations, unread, reveals } = let
    ...
    [ Just state
    , Just $ HH.span [ HS.class_ "own-post-stat" ] $
        [ Icons.messageCircle
