module TeamTavern.Client.Components.Team.ContactsFormInput (Input, Output, Slot, emptyInput, contactsFormInput) where
...
render
    ...
    , discordServer, discordServerError
    ...
    , responsiveInputGroups
        ...
        , discordServerInputGroup discordServer UpdateDiscordServer discordServerError
        ]
...
handleAction (UpdateDiscordServer discordServer) = H.modify _ { discordServer   = discordServer } >>= raiseOutput
...
handleAction (UpdateUbisoftUsername username)    = H.modify _ { ubisoftUsername = username      } >>= raiseOutput
