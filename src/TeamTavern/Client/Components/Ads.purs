...
descriptionLeaderboard = HH.div [ HP.id_ "nn_lb2", HS.class_ "description-leaderboard" ] []

stickyLeaderboard :: forall slots action. HH.HTML slots action
stickyLeaderboard = HH.div [ HP.id_ "nn_lb1", HS.class_ "sticky-leaderboard" ] []
...
mobileStickyLeaderboard = HH.div [ HP.id_ "nn_mobile_lb1_sticky", HS.class_ "sticky-leaderboard" ] []
