...
-- Players named with one action each, such as the blocked list.
personRows :: ∀ w i. Array (HH.HTML w i) -> HH.HTML w i
personRows = HH.ul [ HS.class_ "person-rows" ]

personRow :: ∀ w i. String -> HH.HTML w i -> HH.HTML w i
personRow name action =
